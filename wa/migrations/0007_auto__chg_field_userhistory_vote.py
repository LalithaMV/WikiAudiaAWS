...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserHistory.vote'
        db.alter_column(u'wa_userhistory', 'vote', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

    def backwards(self, orm):

        # Changing field 'UserHistory.vote'
        db.alter_column(u'wa_userhistory', 'vote', self.gf('django.db.models.fields.CharField')(default=None, max_length=2))

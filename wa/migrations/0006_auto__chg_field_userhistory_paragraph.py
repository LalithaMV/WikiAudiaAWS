...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserHistory.paragraph'
        db.alter_column(u'wa_userhistory', 'paragraph_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['wa.Paragraph'], null=True))

    def backwards(self, orm):

        # Changing field 'UserHistory.paragraph'
        db.alter_column(u'wa_userhistory', 'paragraph_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['wa.Paragraph']))
    ...
    models = {
        ...
        u'wa.userhistory': {
            ...
            'logoutTime': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 20, 0, 0)'}),

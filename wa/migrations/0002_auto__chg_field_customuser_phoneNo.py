...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CustomUser.phoneNo'
        db.alter_column(u'wa_customuser', 'phoneNo', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        u'wa.customuser': {
            ...
            'phoneNo': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '12'}),

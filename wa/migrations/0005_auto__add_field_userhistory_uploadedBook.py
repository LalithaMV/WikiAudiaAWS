...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserHistory.uploadedBook'
        db.add_column(u'wa_userhistory', 'uploadedBook',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['wa.Book'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserHistory.uploadedBook'
        db.delete_column(u'wa_userhistory', 'uploadedBook_id')
